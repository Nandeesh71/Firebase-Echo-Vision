...
{showModal && (
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
    <div className="bg-white rounded-3xl shadow-2xl max-w-lg w-full p-8 relative animate-in fade-in duration-300">
      ...
      <button
        onClick={() => {
          window.location.href = "mailto:team71stelites@gmail.com?subject=Echo%20Vision%20Collaboration%20Inquiry&body=Hello%20Echo%20Vision%20Team%2C%0D%0A%0D%0AI%20am%20interested%20in%20collaborating%20with%20Echo%20Vision.%20Please%20let%20me%20know%20how%20we%20can%20work%20together.%0D%0A%0D%0AThank%20you!%0D%0A";
        }}
